...
// CONCATENATED MODULE: ./components/news/Items.js
...
function NewItems({
  ...
  return __jsx("div", {
    ...
    src: data.base_image === null ? `https://th2dev.mangoads.com.vn/themes/storefront/public/images/image.svg?v=5e12e47624638` : data.base_image,
    alt: data.title,
    onClick: () => router.push('/news/[slug]', `/news/${data.url}`)
  })), __jsx("div", {
    className: "item-content ml-3"
  }, __jsx("p", {
    onClick: () => router.push('/news/[slug]', `/news/${data.url}`)
  }, data.title), __jsx("p", null, data.shortDescription)));
}

/* harmony default export */ var Items = (NewItems);
...
function News({
  ...
  return news_jsx(layout["a" /* default */], {
    title: 'News'
  }, news_jsx("div", {
    className: "container main_content"
  }, news_jsx("h1", {
    className: "text-center"
  }, "Tin t\u1EE9c"), news_jsx("div", {
    className: "mb-4"
  }, news_jsx("h4", null, "Tin n\u1ED5i b\u1EADt"), Object(external_lodash_["map"])(list, values => {
    if (values.is_sticky === 1) {
      return news_jsx(Items, {
        data: values,
        key: values.newsId
      });
    }
    ...
    return null;
  })), news_jsx("div", null, news_jsx("h4", null, "Tin g\u1EA7n \u0111\xE2y"), Object(external_lodash_["map"])(list, values => {
...
News.getInitialProps = async () => {
  let list = [];
  const res = await Object(news["e" /* getNewService */])();
...
/* harmony default export */ var pages_news = __webpack_exports__["default"] = (News);
