...
module.exports = __webpack_require__("hJql");
...
function About({
  ...
  return __jsx(external_react_default.a.Fragment, null, __jsx("main", {
    id: "main",
    className: "sec-tb"
  }, __jsx("div", {
    className: "container"
  ...
  }, t('page_about.title')), __jsx("div", {
    className: " sec-b filter-category text-center"
  }, __jsx("select", {
    className: "select",
    onChange: evnets => setYear(evnets.target.value),
    value: year
  }, __jsx("option", null, t('year')), __jsx("option", {
    value: 2020
  }, "2020"), __jsx("option", {
    value: 2021
  }, "2021"))), __jsx("div", {
    className: "list-5 row list-item"
  }, Object(external_lodash_["map"])(listNews.news, item => {
    return __jsx("div", {
      className: "col-md-4",
      key: item.newsId
    }, __jsx("a", {
      href: `/news/${item.url}`,
      className: "item efch-2 ef-img-l equal"
    }, __jsx("div", {
      ...
      className: "date"
    }, external_moment_default()(item.created_at).format('DD/MM/YYYY')), __jsx("h4", {
...
const mapDispatchToProps = {
  getNews: actions["e" /* NewsActions */].fillNesByCategoryAction
};
/* harmony default export */ var about = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Object(i18n["b" /* withTranslation */])('common')(About)));
// CONCATENATED MODULE: ./components/investors/New.js
  ...
  return New_jsx("section", {
    ...
    if (index < 2) {
      return New_jsx("div", {
        ...
        className: "date"
      }, external_moment_default()(item.created_at).format('DD-MM-YYYY')), New_jsx("h4", {
        className: "title line2"
      }, item.title), New_jsx("div", {
        className: "desc line2"
      }, item.shortDescription))));
    }
    ...
    className: "widget-ndt"
  }, New_jsx("div", null, New_jsx("a", {
    href: "./"
  }, New_jsx("img", {
    height: "50",
    ...
    className: "t2"
  }, "+100 ", New_jsx("br", null), "+0.2%")), New_jsx("p", {
    className: "desc"
  }, "Ng\xE0y c\u1EADp nh\u1EADt 27/02/2020"), New_jsx("ul", {
    className: "list"
  }, New_jsx("li", null, New_jsx("span", {
    className: "t1"
  }, "S\xE0n"), ' ', New_jsx("span", {
    className: "t2"
  }, "HOSE ", New_jsx("span", {
    className: "t3"
  }, "(MBB)"), ' ')), New_jsx("li", null, New_jsx("span", {
    className: "t1"
  }, "KLGD"), ' ', New_jsx("span", {
    className: "t2"
  }, "722.680 ", New_jsx("span", {
    className: "t3"
  }, "(CP)"), ' ')), New_jsx("li", null, New_jsx("span", {
    className: "t1"
  }, "GTGD"), ' ', New_jsx("span", {
    className: "t2"
  }, "33.862,00 ", New_jsx("span", {
    className: "t3"
  }, "(Tri\u1EC7u VND)"), ' ')), New_jsx("li", null, New_jsx("span", {
    className: "t1"
  }, "V\u1ED1n ho\xE1"), ' ', New_jsx("span", {
    className: "t2"
  }, "189.437,05 ", New_jsx("span", {
    className: "t3"
  }, "(T\u1EF7 VND)"), ' ')), New_jsx("li", null, New_jsx("span", {
    className: "t1"
  }, "KLCP"), ' ', New_jsx("span", {
    className: "t2"
  }, "4.022.018.040 ", New_jsx("span", {
    className: "t3"
  }, "(CP)"), ' ')))))), New_jsx("div", {
    className: "list-5 row list-item"
  }, Object(external_lodash_["map"])(data, (item, index) => {
    if (index >= 2) {
      return New_jsx("div", {
        ...
        href: `/news/${item.url}`,
        className: "item efch-3 ef-img-l "
      }, New_jsx("div", {
        className: "divtext"
      }, New_jsx("div", {
        className: "date"
...
const New_mapStateToProps = state => {
  return {
    data: state.investorsReducer.listNewInvestor
  };
};

const New_mapDispatchToProps = {
  getNews: actions["a" /* InvestorsActions */].getNewInvestorAction
};
/* harmony default export */ var New = (Object(external_react_redux_["connect"])(New_mapStateToProps, New_mapDispatchToProps)(News));
// CONCATENATED MODULE: ./components/investors/Share.js
var Share_jsx = external_react_default.a.createElement;


function Share() {
  return Share_jsx("section", {
  ...
  }, "C\u1ED5 phi\u1EBFu MB")), Share_jsx("div", null, Share_jsx("img", {
    className: " loaded loaded",
    "data-lazy-type": "image",
...
/* harmony default export */ var investors_Share = (Share);
// CONCATENATED MODULE: ./components/investors/DowloadVideo.js
...
function DowloadVideos({
  ...
  return DowloadVideo_jsx("section", {
    className: "sec-tb "
  }, DowloadVideo_jsx("div", {
    className: "container sec-tb"
  }, DowloadVideo_jsx("div", {
    className: "entry-head"
  }, DowloadVideo_jsx("h2", {
    className: "ht efch-1 ef-img-l"
  }, "H\u1ECDp c\u1ED5 \u0111\xF4ng"), DowloadVideo_jsx("a", {
    className: "viewall",
    href: "#"
  }, "Xem t\u1EA5t c\u1EA3 ", DowloadVideo_jsx("i", {
    className: "icon-arrow-1"
  }))), Object(external_lodash_["map"])(listRegulation, item => {
    if (item.investors.length > 0) {
      return DowloadVideo_jsx("div", {
        key: item.year
      }, DowloadVideo_jsx(download["b" /* DowloadVideo */], {
        data: item.investors,
        year: item.year,
        isChecked: true
      }));
...
const DowloadVideo_mapDispatchToProps = {
  seachRegulation: actions["h" /* RegulationActions */].getRegulationByYear
};
/* harmony default export */ var DowloadVideo = (Object(external_react_redux_["connect"])(mapStateToProp, DowloadVideo_mapDispatchToProps)(DowloadVideos));
// EXTERNAL MODULE: ./services/regulation.js
var regulation = __webpack_require__("HSqs");

// CONCATENATED MODULE: ./components/investors/Financial.js
var Financial_jsx = external_react_default.a.createElement;
...
function Financial() {
  ...
  const getList = () => {
    Object(regulation["b" /* getRegulationListYear */])(1, 0, 10, 0, 0).then(res => {
  ...
  return Financial_jsx("section", {
    className: "sec-b sec-dt-2"
  }, Financial_jsx("div", {
    className: "container"
  }, Financial_jsx("div", {
    className: "entry-head"
    ...
    className: "ht efch-1 ef-img-l"
  }, "B\xE1o c\xE1o t\xE0i ch\xEDnh"), Financial_jsx("a", {
    className: "viewall",
    href: "#"
  }, "Xem t\u1EA5t c\u1EA3 ", Financial_jsx("i", {
    className: "icon-arrow-1"
  }))), Financial_jsx("div", {
    className: "row"
  }, Object(external_lodash_["map"])(list.sort((a, b) => a.year - b.year), items => {
    return Financial_jsx("div", {
      className: "col-md-6",
      key: items.year
    }, Financial_jsx("div", {
      className: "boxwidget"
    ...
    }, items.year), Financial_jsx("ul", {
      className: "list-download "
    }, Object(external_lodash_["map"])(items.investors, item => Financial_jsx("li", {
      key: item.id
    }, Financial_jsx("span", {
      className: "title"
    }, Financial_jsx("i", {
      className: "icon-t14"
    }), " ", item.name), Financial_jsx("span", {
      className: "down"
    }, Financial_jsx("a", {
      href: item.urlFile,
      download: true
...
/* harmony default export */ var investors_Financial = (Financial);
// CONCATENATED MODULE: ./components/investors/index.js
var investors_jsx = external_react_default.a.createElement;
...
function Investors() {
  return investors_jsx("div", null, investors_jsx(New, null), investors_jsx(investors_Share, null), investors_jsx(DowloadVideo, null), investors_jsx(investors_Financial, null));
}

/* harmony default export */ var investors = (Investors);
// CONCATENATED MODULE: ./components/otherNews/tab/Question.js
...
function TabQuestion() {
  ...
  return Question_jsx("div", {
    ...
    className: "max750 mb-40"
  }, Question_jsx("div", {
    className: "inline-table w100"
  }, Question_jsx("h3", {
    className: "ctext"
  }, t('you_encounter_difficulties')), Question_jsx("div", {
    className: "c100"
  }, Question_jsx("form", {
    role: "search",
    className: "searchform input h50"
  }, Question_jsx("input", {
    type: "text",
    placeholder: "H\xE3y cho ch\xFAng t\xF4i bi\u1EBFt kh\xF3 kh\u0103n c\u1EE7a b\u1EA1n",
    name: "s",
    className: "textinput"
  }), Question_jsx("button", {
    type: "submit",
  ...
  }, " ")))))), Question_jsx("section", {
    className: "sec-b sec-cauhoi"
  }, Question_jsx("div", {
    className: "container"
  }, Question_jsx(download["e" /* ListDowloadQA */], {
    type: 9
  }))));
}

/* harmony default export */ var Question = (TabQuestion);
// CONCATENATED MODULE: ./components/otherNews/tab/index.js


// CONCATENATED MODULE: ./components/otherNews/index.js
var otherNews_jsx = external_react_default.a.createElement;
...
function OtherNews() {
  ...
  return otherNews_jsx("div", {
    className: "container"
  }, otherNews_jsx("div", {
    className: "cttab-v3 mt-4"
  }, otherNews_jsx("div", {
    className: "tab-menu max750"
  }, otherNews_jsx("div", {
    className: activeTab === 1 ? 'active' : '',
    onClick: () => setActiveTab(1)
  }, otherNews_jsx("span", null, t('question_answer'))), otherNews_jsx("div", {
    className: activeTab === 2 ? 'active' : '',
    onClick: () => setActiveTab(2)
  }, otherNews_jsx("span", null, t('rating_report'))), otherNews_jsx("div", {
    className: activeTab === 3 ? 'active' : '',
    onClick: () => setActiveTab(3)
  }, otherNews_jsx("span", null, t('documents')))), otherNews_jsx("div", {
    className: "tab-content"
  }, otherNews_jsx("div", {
    className: activeTab === 1 ? 'active' : ''
  }, activeTab === 1 && otherNews_jsx(Question, null)), otherNews_jsx("div", {
    className: activeTab === 2 ? 'active' : ''
  }, activeTab === 2 && otherNews_jsx(download["d" /* ListDowloadFIle */], {
    type: 8
  })), otherNews_jsx("div", {
    className: activeTab === 3 ? 'active' : ''
  }, activeTab === 3 && otherNews_jsx(download["d" /* ListDowloadFIle */], {
    type: 5
  })))));
}
...
/* harmony default export */ var otherNews = (Object(i18n["b" /* withTranslation */])('common')(OtherNews));
// EXTERNAL MODULE: external "react-select"
var external_react_select_ = __webpack_require__("vtRj");
var external_react_select_default = /*#__PURE__*/__webpack_require__.n(external_react_select_);

// CONCATENATED MODULE: ./components/transaction/BoxSearch.js
var BoxSearch_jsx = external_react_default.a.createElement;
...
function BoxSearch({
  ...
  const {
    0: branches_type,
    1: setBranchesType
  } = Object(external_react_["useState"])('Branch');
  const {
    0: province,
    1: setProvince
  } = Object(external_react_["useState"])('');
  const {
    0: query,
    1: setQuery
  } = Object(external_react_["useState"])(''); // district, branches_type, province, query
  ...
  return BoxSearch_jsx("div", {
    ...
    className: "item"
  }, "Chi nh\xE1nh")), BoxSearch_jsx("li", {
    className: branches_type === 'ATM' ? 'col-6 active' : 'col-6',
    onClick: () => setBranchesType('ATM')
  }, BoxSearch_jsx("span", {
    className: "item"
  }, "ATM"))), BoxSearch_jsx("div", {
    className: "form-search-focus mb-20"
  }, BoxSearch_jsx("input", {
    type: "text",
    placeholder: "\u0110\u1ECBa \u0111i\u1EC3m",
    onChange: event => setQuery(event.target.value)
  }), BoxSearch_jsx("button", null, BoxSearch_jsx("i", {
    className: "icon-search-2"
  }))), BoxSearch_jsx("div", {
    className: "mb-20"
  }, BoxSearch_jsx("div", null, "T\u1EC9nh/ Th\xE0nh ph\u1ED1"), BoxSearch_jsx(external_react_select_default.a, {
    ...
    className: "mb-20"
  }, BoxSearch_jsx("div", null, "Qu\u1EADn/Huy\u1EC7n"), BoxSearch_jsx(external_react_select_default.a, {
  ...
  }, Object(external_lodash_["map"])(listBranches, (branches, index) => BoxSearch_jsx("div", {
    ...
    className: "title"
  }, branches.address_name), BoxSearch_jsx("div", {
    className: "address"
  }, branches.address))))));
}

const BoxSearch_mapStateToProps = state => {
  return {
...
const BoxSearch_mapDispatchToProps = {
  searchBranches: actions["c" /* MapActions */].searchBranchesAction,
  getProvince: actions["c" /* MapActions */].getProvinceAction,
  getDistrict: actions["c" /* MapActions */].getDistrictAction
};
/* harmony default export */ var transaction_BoxSearch = (Object(external_react_redux_["connect"])(BoxSearch_mapStateToProps, BoxSearch_mapDispatchToProps)(BoxSearch));
// CONCATENATED MODULE: ./components/transaction/index.js
var transaction_jsx = external_react_default.a.createElement;



function Transaction() {
  return transaction_jsx("main", {
    className: "page-diem-atm",
    id: "main"
  }, transaction_jsx("div", {
    className: "wrap-list-map"
  }, transaction_jsx("div", {
    className: "row grid-space-0"
  }, transaction_jsx("div", {
    className: "col-md-4 "
  }, transaction_jsx(transaction_BoxSearch, null)), transaction_jsx("div", {
    className: "col-md-8"
  }))));
}

/* harmony default export */ var transaction = (Transaction);
// EXTERNAL MODULE: external "next/router"
var router_ = __webpack_require__("4Q3z");

// CONCATENATED MODULE: ./pages/page/[...name].js
...
function Page({
  ...
  let routerUrl = null;
  let params = '';
  Object(external_lodash_["map"])(name, url => params = `${params}/${url}`);
  routerUrl = params.slice(1, params.length);
  Object(external_react_["useEffect"])(() => {
    getPage(routerUrl);
  }, []);
  console.log(name);
  return _name_jsx(layout["a" /* default */], {
    title: list.meta_title
  }, _name_jsx("div", {
    className: "main_content"
  }, _name_jsx(common["b" /* Carousel */], {
    silder: silder
  }), _name_jsx(common["e" /* MenuMiddle */], {
    data: menuMiddle,
    query: routerUrl
  }), list.id === 34652 && _name_jsx(investors, null), list.id === 34653 && _name_jsx(investors, null), list.id === 34654 && _name_jsx(download["d" /* ListDowloadFIle */], {
    type: 1,
    search: true
  }), list.id === 34655 && _name_jsx(download["f" /* ListDowloadVideo */], {
    type: 2
  }), list.id === 34656 && _name_jsx(download["f" /* ListDowloadVideo */], {
    type: 3
  }), list.id === 34657 && _name_jsx(download["d" /* ListDowloadFIle */], {
    type: 4,
    search: true
  }), list.id === 34658 && _name_jsx(download["d" /* ListDowloadFIle */], {
    type: 6,
    search: true
  }), list.id === 34660 && _name_jsx(otherNews, null), list.id === 34217 && _name_jsx(about, null), list.id === 34669 && _name_jsx(transaction, null), _name_jsx(common["a" /* BlockRender */], {
    data: list.pageBlocks
  }), list.template === 4 && _name_jsx(common["d" /* DowloadCategory */], null)));
}

const _name_mapStateToProp = state => {
  return {
...
const _name_mapDispatchToProps = {
  getPage: actions["f" /* PageActions */].getHomeAction
};
...
/* harmony default export */ var _name_ = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(_name_mapStateToProp, _name_mapDispatchToProps)(Object(i18n["b" /* withTranslation */])('common')(Page)));
