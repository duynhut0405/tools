...
module.exports = __webpack_require__("a2ds");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("okHz");
/* harmony import */ var _components_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("lCwK");
/* harmony import */ var _services_news__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("vgnt");
...
/* harmony import */ var react_html_parser__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("gifY");
...
function New({
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    const res = Object(_services_news__WEBPACK_IMPORTED_MODULE_3__[/* getNewByUri */ "c"])(router.query.slug);
    res.then(respone => {
      if (respone !== undefined && respone !== null && respone.status === 200) {
        ...
        if (respone.data.categories !== null && respone.data.categories.length > 0) {
          Object(_services_news__WEBPACK_IMPORTED_MODULE_3__[/* getNewCategoryIdService */ "d"])(respone.data.categories[0].id).then(data => {
  ...
  }, [_services_news__WEBPACK_IMPORTED_MODULE_3__[/* getNewByUri */ "c"], getSocialLink]);
  return __jsx(_components_layout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], {
    ...
    className: "date"
  }, moment__WEBPACK_IMPORTED_MODULE_4___default()(news.created_at).format('DD/MM/YYYY')), __jsx(_components_common__WEBPACK_IMPORTED_MODULE_2__[/* Social */ "g"], {
    data: socialLink
  })), __jsx("div", {
    className: "entry-content"
  }, react_html_parser__WEBPACK_IMPORTED_MODULE_7___default()(news.description)), __jsx("br", null), __jsx("div", {
    className: "tags"
  }, __jsx("h2", null, "N\u1ED9i dung li\xEAn quan"), Object(lodash__WEBPACK_IMPORTED_MODULE_5__["map"])(news.categories, item => __jsx("a", {
    className: "tag",
    href: "#",
    key: item.id
  }, item.name)))))), __jsx("section", {
    className: "sec-tb"
  }, __jsx("div", {
    className: "container"
  }, __jsx("div", {
  ...
  }, Object(lodash__WEBPACK_IMPORTED_MODULE_5__["map"])(Object(lodash__WEBPACK_IMPORTED_MODULE_5__["filter"])(relatedPost, (item_a, item_b) => relatedPost.indexOf(item_a) === item_b), (item, index) => {
    if (index < 2) {
      return __jsx("div", {
        className: "col-md-6",
        key: item.newsId
        ...
        className: "date"
      }, moment__WEBPACK_IMPORTED_MODULE_4___default()(item.created_at).format('DD/MM/YYYY')), __jsx("h4", {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_8__["connect"])(mapStateToProps, null)(New));
