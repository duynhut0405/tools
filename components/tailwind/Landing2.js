                ...
                <div className="pt-5 pb-6">
                  <div className="space-y-1 px-2">
                    {navigation.map(item => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="block rounded-md px-3 py-2 text-base font-medium text-[#f0a71d] hover:bg-gray-50"
                      >
                        {item.name}
                      </a>
                    ))}
                  ...
                  <div className="mt-6 px-5">
                    <p className="text-center text-base font-medium text-gray-500">
                      Existing customer?{' '}
                      <a href="#" className="text-[#f0a71d] hover:underline">
                        Login
                      </a>
                    </p>
                  </div>
                        ...
                        <div className="sm:flex">
                          <div className="min-w-0 flex-1">
                            ...
                            <input
                              ...
                              className="block w-full rounded-md border-0 px-4 py-3 text-base text-[#f0a71d] placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-gray-900"
                            />
                          </div>
          ...
          <div className="relative bg-gray-50 pt-16 sm:pt-24 lg:pt-32">
            <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-[1536px] lg:px-8">
              <div>
                ...
                <p className="mt-2 text-3xl font-bold tracking-tight text-[#f0a71d] sm:text-4xl">
                    ...
                    <div key={feature.name} className="pt-6">
                      <div className="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                        <div className="-mt-6">
                          ...
                          <h3 className="mt-8 text-lg font-medium tracking-tight text-[#f0a71d]">
                            {feature.name}
                          </h3>
              ...
              <div className="md:ml-auto md:w-1/2 md:pl-10">
                ...
                <div className="mt-8">
                  <div className="inline-flex rounded-md shadow">
                    <a
                      href="#"
                      className="inline-flex items-center justify-center rounded-md border border-transparent bg-white px-5 py-3 text-base font-medium text-[#f0a71d] hover:bg-gray-50"
                    >
