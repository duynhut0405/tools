...
function FormRate({
  ...
  const openModalTab = (close_id, blue_id, open_id, close_id_2, isLaiSuat) => {
    ...
    y.style.borderBottom = '2px solid #f0a71d';
    y.style.color = '#f0a71d';
  ...
  const getInterestRate = async () => {
    ...
    req.open('GET', 'https://ACB3.mangoads.com.vn:8443/uploads/excel/goldExchange.xlsx', true);
      ...
      {data !== undefined && (
        <div className="container">
          <div className="row list-item list-2">
            <div className="col-lg-4">
              <div className="divquidoi">
                ...
                <h5
                  style={{ color: '#686868', fontSize: '14px', maxWidth: '264px', height: '43px' }}
                >
                  {t('change_foreign_currency_custom')}
                </h5>
                ...
                <div
                  ...
                  style={{ position: 'relative', top: '5px', paddingBottom: '10px' }}
                >
                  <a
                    className="t5-custom"
                    onMouseOver={() => {
                      setDisplayNote1(true);
                    }}
                    onMouseLeave={() => {
                      setDisplayNote1(false);
                    }}
                  >
                  ...
                  <div>
                    ...
                    >
                      {typeSearch == 4 ? t('close_read_more') : t('read_more')}
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="divquidoi widget widget-2" style={{ backgroundColor: '#DCF9ED' }}>
                ...
                <div className="tabset">
                  <input
                    ...
                    id="tset3"
                    onClick={() => {
                      openModalTab(`tset4-1`, 'tset3-1', `loan`, `deposits`, true);
                    }}
                  ></input>
                  <label
                    for="tset3"
                    id="tset3-1"
                    style={{ borderBottom: '2px solid #f0a71d', color: '#f0a71d' }}
                  >
                  ...
                  <input
                    ...
                    id="tset4"
                    onClick={() => {
                      openModalTab(`tset3-1`, 'tset4-1', `deposits`, 'loan', true);
                    }}
                  ></input>
                  <label for="tset4" id="tset4-1">
                    {t('deposits')}
                  </label>
                  <div className="tab-panels">
                    <div className="tab-panel" id="loan">
                      <div
                        className="content_2"
                        style={{ display: displayNote2 ? 'none' : 'block', height: '219px' }}
                      >
                        <div className="item-group-custom space-20">
                          <div className="item-group-addon-custom">{minLoan.interest_rate}</div>
                      ...
                      <div className="action-custom">
                        <a
                          className="t5-custom"
                          onMouseOver={() => {
                            setDisplayNote2(true);
                          }}
                          onMouseLeave={() => {
                            setDisplayNote2(false);
                          }}
                        >
                          <div style={{ display: 'table' }}>
                            <div style={{ display: 'table-cell', paddingRight: '5px' }}>
                        ...
                        <div>
                          ...
                          >
                            {typeTable == 2 ? t('close_read_more') : t('read_more')}
                          </a>
                        </div>
                      </div>
                    </div>
                    <div className="tab-panel" style={{ display: 'none' }} id="deposits">
                      ...
                      >
                        <div className="item-group-custom space-20">
                          <div className="item-group-addon-custom">{maxDeposits.interest_rate}</div>
                          <div className="item-group-content-custom">
                            <div className="t1 w6">%</div>
                      ...
                      <div className="action-custom">
                        ...
                        <div>
                          ...
                          >
                            {typeTable == 3 ? t('close_read_more') : t('read_more')}
                          </a>
                        </div>
                      </div>
                    </div>
              ...
              <div className="divquidoi widget widget-2" style={{ backgroundColor: '#F2F3FF' }}>
                ...
                <div className="tabset">
                  <input
                    ...
                    id="tset5"
                    onClick={() => {
                      openModalTab(`tset6-1`, 'tset5-1', `mua`, `ban`);
                    }}
                  ></input>
                  <label
                    for="tset5"
                  ...
                  <input
                    ...
                    id="tset6"
                    onClick={() => {
                      openModalTab(`tset5-1`, 'tset6-1', `ban`, 'mua');
                    }}
                  ></input>
                  <label for="tset6" id="tset6-1">
                    {t('purchase_price')}
                  </label>
                  <div className="tab-panels">
                    <div className="tab-panel" id="mua">
                      <div
                        className="content_3"
                        style={{ display: displayNote3 ? 'none' : 'block', height: '219px' }}
                      >
                        <div className="t1-custom">
                          {currentGold.buy_exchange}
                          <span className="t2-custom">
                            vnđ/
                            <br />
                            {t('chi_vang')}
                          </span>
                      ...
                      <div className="action-custom">
                        <a
                          className="t5-custom"
                          onMouseOver={() => {
                            setDisplayNote3(true);
                          }}
                          onMouseLeave={() => {
                            setDisplayNote3(false);
                          }}
                        >
                          <div style={{ display: 'table' }}>
                            <div style={{ display: 'table-cell', paddingRight: '5px' }}>
                        ...
                        <div>
                          ...
                          >
                            {typeGold == 1 ? t('close_read_more') : t('read_more')}
                          </a>
                        </div>
                      </div>
                    </div>
          ...
          <div className="row list-item list-2" id="ghi-chu-group" style={{ display: 'none' }}>
            <div
              className="col-lg-4 ghi-chu"
              id="ghi-chu-1"
              style={{ padding: '30px', visibility: 'hidden' }}
            >
              <div
                className="divquidoi widget widget-2 shadow-custom-box"
                ...
                <div className="search_ tigia mb-30 max950 ">
                  <div className="row center">
                    ...
                    <div className="col-sm-7 col-md-5 col-lg-6">
                      <DatePicker selected={startDate} onChange={setStartDate}></DatePicker>
                    </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <th style={{ textAlign: 'center' }}>
                          {t('price')}(VNĐ/{t('chi_vang')})
                        </th>
                        <th style={{ textAlign: 'center' }}>
                          {t('purchase_price')}(VNĐ/{t('chi_vang')})
                        </th>
                      </tr>

                      <tr>
                        <td>
                          <div className="t3-custom" style={{ width: '100%', textAlign: 'center' }}>
                            {currentGold.gold_1_name}
                          </div>
                          <div className="t4-custom" style={{ width: '100%', textAlign: 'center' }}>
                            {currentGold.des_vi}
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div className="t3-custom" style={{ width: '100%', textAlign: 'center' }}>
                            {currentGold.gold_2_name}
                          </div>
                          <div className="t4-custom" style={{ width: '100%', textAlign: 'center' }}>
                            {currentGold.des_2_vi}
                          </div>
                        </td>
