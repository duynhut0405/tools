        ...
        <div className="container">
          <div className="video-banner-custom-1">
            <div className="row center" style={{ margin: '0px', padding: '0px' }}>
              ...
              <div
                className="col-lg-6"
                style={{ marginBottom: '0px', padding: '40px', paddingLeft: '60px' }}
              >
                <div className="divtext entry-content">
                  <h2 className="ht" style={{ fontSize: '24px', fontWeight: 'bold' }}>
        ...
        <div className="container">
          <div className="video-banner-custom-1">
            <div
              ...
              style={{ margin: '0px', padding: '0px', background: '#F2F3FF' }}
            >
              <div className="col-lg-6" style={{ marginBottom: '0px', padding: '0px' }}>
                {!active && (
                  <div
        ...
        <div className="container">
          <div className="video-banner" style={{ backgroundColor: backGroundColor }}>
            <div className="row center">
              <div className="col-lg-5" style={{ marginBottom: '0px' }}>
                <div className="divtext entry-content">
                  <h2 className="ht" style={{ fontSize: '24px' }}>
                    {ReactHtmlParser(items.note_1)}
                  </h2>
                  <p className="desc">
                    {ReactHtmlParser(items.note_2)}
                  ...
                  {items.text_action === undefined || items.text_action === '' ? (
                    ...
                    <a
                      className="btn btn-video-custom"
                      href={items.url === undefined ? '#' : items.url}
    ...
    return (
      <section className={`sec-t sec-b sec-video2`} id={id}>
        <div className="container" style={{ textAlign: 'center' }}>
          <img
            class=" loaded loaded img-banner"
            dataLazyType="image"
            dataLazySrc={img}
            src={img}
            style={{ borderRadius: '5px', paddingBottom: '0' }}
          />
          <a
            href={items.url_1}
            className="btn-custom"
            style={{ top: items.top, left: items.left, height: items.height, width: items.width }}
          ></a>
          <a
            href={items.url_2}
            className="btn-custom"
  ...
  if (items.type === '8') {
    return (
      <section
        ...
        id={id}
        style={{
          paddingTop: items.note_2 !== undefined || items.note_2 !== '' ? '16px' : '72px',
          paddingBottom: items.urlImage != undefined ? '80px' : '0px'
        }}
      >
        <div className="container">
          <div className="text-center blog-custom">
            <div className="blog-custom-1" style={{ borderBottom: 'unset' }}>
              <h2 className="intro-title-custom-1">{ReactHtmlParser(items.note_2)}</h2>
              <div>
          ...
          <div
            ...
            style={{
              margin: 'auto',
              textAlign: 'center',
              display: items.urlImage != undefined ? 'block' : 'none'
            }}
          >
            {!active && (
              <div
