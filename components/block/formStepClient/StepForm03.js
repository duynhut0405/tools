            ...
            <div className="max750">
              <form autoComplete="on" className="row list-item form-contact c-form1" ref={form01}>
                ...
                <div className="col-12">
                  ...
                  <p>
                    3. Trả gốc, lãi, và các chi phí, phạt phát sinh (nếu có) của khoản vay đúng hạn
                    cho MB.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    chia sẻ và trao đổi những thông tin liên quan đến Chúng tôi và khoản vay của
                    Chúng tôi; đồng thời đồng ý và cho phép MB được tìm kiếm, xác minh, cung cấp
                    thông tin liên quan đến Chúng tôi và khoản vay của Chúng tôi từ/cho bất kỳ bên
                    thứ ba nào khác theo quy định của MB.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    giữ nguyên hiệu lực, không thay đổi thông tin và đảm bảo đúng, phù hợp với hiện
                    trạng thực tế của tại thời điểm đề nghị vay vốn lần này.
                  </p>
                  <p>
                    8. Tuân thủ các điều khoản quy định của Hợp đồng tín dụng, Hợp đồng bảo đảm tiền
                    vay và các văn bản ký kết với MB (nếu có).
                  </p>
                </div>
